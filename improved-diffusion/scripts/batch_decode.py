...
full_lst = glob.glob(sys.argv[1])  # {path-to-diffusion-lm}路径下的所有文件
top_p = -1.0 if len(sys.argv) < 2 else sys.argv[2]  # -1.0
print(f'top_p = {top_p}')
pattern_ = 'model' if len(sys.argv) < 3 else sys.argv[3]  # ema
